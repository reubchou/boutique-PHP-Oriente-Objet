					...
					<div class="col-md-6">
						<div class="single-desc">
							...
							<div class="middle-single">
								...
								<h1><?php echo $itemsHome[0]["libelle"] ?></h1>
							...
							<div class="single-price">
							   <ul>
									<li><span class="low-price"><?php echo $itemsHome[0]["price"] ?>€</span></li>
								</ul>
						    </div>

						    <div class="single-infos">
						    	<p><span>Catégorie:</span><?php echo $itemsHome[0]["categories"] ?></p>
							...
							<div class="single-descript">
								<p><?php echo $itemsHome[0]["description"] ?></p>
							</div>
